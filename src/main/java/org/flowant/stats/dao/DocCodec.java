...
/**
 * 1. package 변동에 따른 import 구문들이 추가됨.
 * 2. implements CollectibleCodec<Doc> 부분에서 Document를 Doc로 변경 함.
 * 상단 1. 2.부분들을 제외하고 package org.bson.codecs.DocumentCodec 소스파일을 그대로 사용 함.
 * Document를 상속받은 Doc 인스턴스 생성을 위한 Codec
 *
 * @see org.flowant.stats.dao.Doc
 */
